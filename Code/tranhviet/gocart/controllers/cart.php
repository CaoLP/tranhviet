...
//        print_r($base_url);
            ...
            $result = $this->Product_model->load_products($config['per_page'], $page, $sort_by['by'], $sort_by['sort']);
            $config['total_rows'] = $result['count'];

            $data['base_url'] = $base_url;
            $config['base_url'] = site_url($base_url) . 'cart/index/';
        ...
        function category($id) {
            ...
            $data['sub_categories'] = $this->Category_model->get_categories($id);
        ...
        function lang() {
            if ($this->session->userdata('user_lang')) {
                ...
                if ($type == 'english') {
                    $this->session->set_userdata("user_lang", "vietnam");
