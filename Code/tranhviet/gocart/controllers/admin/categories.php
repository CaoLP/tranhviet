...
class Categories extends Admin_Controller
{
    ...
    function form($id = false)
    {
        ...
        if ($id) {
            ...
            $data['en_name'] = $category->en_name;
            $data['slug'] = $category->slug;
            $data['description'] = $category->description;
            $data['en_description'] = $category->en_description;
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if (!empty($en_name)) {
                $save['en_name'] = $en_name;
            } else {
                $save['en_name'] = $this->input->post('name');
            }
            $en_description = $this->input->post('en_description');
            if (!empty($en_description)) {
                $save['en_description'] = $en_description;
            } else {
                $save['en_description'] = $this->input->post('description');
            }
