<div class="contentRight">
    <div class="sanpham" style=" height: 100%; margin-top: 0">
        <div class="row" style="margin:10px;;">
            ...
            <?php echo form_open('secure/forgot_password', 'class="form-horizontal" style = "padding-left: 100px;"') ?>
            <fieldset>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        <input type="submit" value="<?php echo lang('reset_password'); ?>" name="submit"
