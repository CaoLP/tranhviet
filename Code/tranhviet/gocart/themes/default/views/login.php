<div class="contentRight">
    <div class="sanpham"  style=" height: 100%; margin-top: 0">
        <div class="row" style="margin:10px;">
                ...
                <?php echo form_open('secure/login', 'class="form-horizontal" style = "padding-left: 100px;"'); ?>
                <fieldset>
                ...
                <div style="text-align:center;">
                    <a href="<?php echo site_url('secure/forgot_password'); ?>"><?php echo lang('forgot_password') ?></a>
