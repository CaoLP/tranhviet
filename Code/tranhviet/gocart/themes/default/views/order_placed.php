        ...
        <div class="row" style="margin: 5px">
            ...
            <div class="row" style="margin: 10px;">
                <div class="span4">
                    ...
                    <?php
                    if (!empty($referral)):?>
                        <div><strong><?php echo lang('heard_about'); ?></strong> <?php echo $referral; ?>
                        </div><?php endif; ?>
                    <?php if (!empty($shipping_notes)): ?>
                        <div>
                        <strong><?php echo lang('shipping_instructions'); ?></strong> <?php echo $shipping_notes; ?>
                        </div><?php endif; ?>
                </div>
            ...
            <table class="table table-bordered table-striped" style="margin-top:20px; width: 97%">
                <thead>
                <tr>
