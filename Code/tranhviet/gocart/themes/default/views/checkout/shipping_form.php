<div class="contentRight">
    <div class="sanpham">
        <div class="row" style="margin: 5px">
            ...
            <?php echo form_open('checkout/step_2', 'style = "padding-left: 60px;"'); ?>
            <div class="row">
                <div class="span6">
                    ...
                    <table class="table">
                        ...
                        foreach ($shipping_methods as $key => $val):
                            ...
                            <tr style="cursor:pointer">
                                <td style="width:16px;">
                                    <label
                                        class="radio"><?php echo form_radio('shipping_method', $ship_encoded, set_radio('shipping_method', $ship_encoded, $checked), 'id="s' . $ship_encoded . '"'); ?></label>
                                </td>
                                <td onclick="toggle_shipping('s<?php echo $ship_encoded; ?>');"><?php echo $key; ?></td>
                                <td onclick="toggle_shipping('s<?php echo $ship_encoded; ?>');">
                                    <strong><?php echo $val['str']; ?></strong></td>
                            </tr>
                        <?php endforeach; ?>
                    </table>
                </div>
