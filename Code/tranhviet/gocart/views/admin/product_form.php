			...
			<div class="tab-pane active" id="product_info">
                ...
                <div class="row">
                    <div class="span8">
                        <label><?php echo lang('excerpt');?></label>
                        <?php
                        $data	= array('name'=>'en_excerpt', 'value'=>set_value('en_excerpt', $excerpt), 'class'=>'span8', 'rows'=>5);
                        echo form_textarea($data);
                        ?>
                    </div>
                </div>
			...
			<div class="option-form" id="option-form-<?php echo $count;?>">
				<div class="row-fluid">
					...
					<div class="span10">
                        ...
                        <input type="text" class="span10" placeholder="<?php echo lang('en_option_name');?>" name="option[<?php echo $count;?>][en_name]" value="<?php echo $po->en_name;?>"/>
					</div>
...
function add_option_value($po, $count, $valcount, $value)
{
	...
	<div class="option-values-form">
		<div class="row-fluid">
			...
			<div class="span2"><input type="text" class="span12" name="option[<?php echo $count;?>][values][<?php echo $valcount ?>][name]" value="<?php echo $value->name ?>" /></div>
            <div class="span2"><input type="text" class="span12" name="option[<?php echo $count;?>][values][<?php echo $valcount ?>][en_name]" value="<?php echo $value->en_name ?>" /></div>
