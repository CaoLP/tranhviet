...
<?php echo form_open($this->config->item('admin_folder') . '/products/form/' . $id); ?>
    ...
    <div class="tab-pane active" id="product_info">
        <legend><?php echo lang('common_lang_vi'); ?></legend>
        <div class="row">
            <div class="span8">
                <?php
        ...
        <hr/>
        <legend><?php echo lang('common_lang_en'); ?></legend>
        <div class="row">
            <div class="span8">
                <?php
                    $data = array('placeholder' => lang('en_name'), 'name' => 'en_name', 'value' => set_value('en_name', $en_name), 'class' => 'span8');
                    echo form_input($data);
                ?>
            </div>
        </div>
        ...
        <div class="row">
            <div class="span8">
                ...
                <?php
                    $data = array('name' => 'en_description', 'class' => 'redactor', 'value' => set_value('en_description', $en_description));
                    echo form_textarea($data);
                ?>
        ...
        <div class="row">
            <div class="span8">
                <label><?php echo lang('excerpt'); ?></label>
                <?php
                    $data = array('name' => 'en_excerpt', 'value' => set_value('en_excerpt', $en_excerpt), 'class' => 'span8', 'rows' => 5);
                    echo form_textarea($data);
                ?>
            </div>
        </div>
                ...
                <fieldset>
                    ...
                    <div class="row" style="padding-top:10px;">
                        <div class="span8">
                            ...
                            <label for="meta"><?php echo lang('meta'); ?>
                                <i><?php echo lang('meta_example'); ?></i></label>
                            <?php
    ...
    <div class="tab-pane" id="product_options">
        ...
        <script type="text/javascript">
            ...
            function add_option(type) {
                ...
                <?php
                $value			= array(array('name'=>'', 'value'=>'', 'weight'=>'', 'price'=>'', 'limit'=>'','en_name'=>'','en_value'=>''));
                $js_textfield	= (object)array('name'=>'','en_name'=>'', 'type'=>'textfield', 'required'=>false, 'values'=>$value);
                $js_textarea	= (object)array('name'=>'','en_name'=>'', 'type'=>'textarea', 'required'=>false, 'values'=>$value);
                $js_radiolist	= (object)array('name'=>'','en_name'=>'', 'type'=>'radiolist', 'required'=>false, 'values'=>$value);
                $js_checklist	= (object)array('name'=>'','en_name'=>'', 'type'=>'checklist', 'required'=>false, 'values'=>$value);
                $js_droplist	= (object)array('name'=>'','en_name'=>'', 'type'=>'droplist', 'required'=>false, 'values'=>$value);
            ...
            function add_option_value(option) {
                ...
                $value	= (object)array('name'=>'', 'value'=>'', 'weight'=>'', 'price'=>'','en_name'=>'','en_value'=>'');
                ?>
            ...
            <div class="span2" style="text-align:center">
                ...
                <div class="row">
                    <div class="span2" style="margin-top:8px;">
                        <a href="#" onclick="add_related_product();return false;" class="btn"
                           title="Add Related Product"><?php echo lang('add_related_product'); ?></a>
                    </div>
                </div>
            </div>
            <div class="span6">
...
<?php
    function add_image($photo_id, $filename, $alt, $caption, $primary = false) {
        ...
        <div class="row gc_photo" id="gc_photo_<?php echo $photo_id; ?>"
            ...
            <div class="span6">
                <div class="row">
                    <div class="span2">
                        <input name="images[<?php echo $photo_id; ?>][alt]" value="<?php echo $alt; ?>" class="span2"
                               placeholder="<?php echo lang('alt_tag'); ?>"/>
                    </div>
                    <div class="span2">
                        <input type="radio" name="primary_image"
                               value="<?php echo $photo_id; ?>" <?php if ($primary) echo 'checked="checked"'; ?>/> <?php echo lang('primary'); ?>
                    </div>
                    <div class="span2">
                        <a onclick="return remove_image($(this));" rel="<?php echo $photo_id; ?>" class="btn btn-danger"
                ...
                <div class="row">
                    <div class="span6">
                        ...
                        <textarea name="images[<?php echo $photo_id; ?>][caption]" class="span6"
                                  rows="3"><?php echo $caption; ?></textarea>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="option-form" id="option-form-<?php echo $count; ?>">
                    <div class="row-fluid">
                        ...
                        <div class="span10">
                            ...
                            <input type="text" class="span10" placeholder="<?php echo lang('en_option_name'); ?>"
                                   name="option[<?php echo $count; ?>][en_name]" value="<?php echo $po->en_name; ?>"/>
                        </div>
                    ...
                    <div style="margin-top:10px;">
                        ...
                        <div class="row-fluid">
                            <?php if ($po->type != 'textarea' && $po->type != 'textfield'): ?>
                                <div class="span1">&nbsp;</div>
                            <?php endif; ?>
                            <div class="span2"><strong>&nbsp;&nbsp;<?php echo lang('name'); ?></strong></div>
                            <div class="span2"><strong>&nbsp;&nbsp;<?php echo lang('en_name'); ?></strong></div>
    ...
    function add_option_value($po, $count, $valcount, $value) {
        ...
        <div class="option-values-form">
            <div class="row-fluid">
                <?php if ($po->type != 'textarea' && $po->type != 'textfield'): ?>
                    <div class="span1"><a class="handle btn btn-mini" style="float:left;"><i
                                class="icon-align-justify"></i></a></div><?php endif; ?>
                ...
                <div class="span2"><input type="text" class="span12"
                                          name="option[<?php echo $count; ?>][values][<?php echo $valcount ?>][en_name]"
                                          value="<?php echo $value->en_name ?>"/></div>
                <div class="span2"><input type="text" class="span12"
