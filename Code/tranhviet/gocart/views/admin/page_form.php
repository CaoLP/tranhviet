	...
	<div class="tab-content">
		<div class="tab-pane active" id="content_tab">
            ...
            <fieldset>
                ...
                <?php
                $data	= array('name'=>'en_title', 'value'=>set_value('en_title', $en_title), 'class'=>'span12');
                echo form_input($data);
                ?>

                <label for="content"><?php echo lang('en_content');?></label>
                <?php
                $data	= array('name'=>'en_content', 'class'=>'redactor', 'value'=>set_value('en_content', $en_content));
                echo form_textarea($data);
                ?>
            </fieldset>
		</div>
		...
		<div class="tab-pane" id="attributes_tab">
			<fieldset>
                ...
                <label for="en_menu_title"><?php echo lang('en_menu_title');?></label>
                <?php
                $data	= array('name'=>'en_menu_title', 'value'=>set_value('en_menu_title', $en_menu_title), 'class'=>'span3');
                echo form_input($data);
                ?>
