        ...
        <div class="navbar-inner">
            <div class="container">
                ...
                <div class="nav-collapse">
                    <ul class="nav">
                        <li><a href="<?php echo $admin_url; ?>admin/changelanguage">
                                <?php
                                if ($this->session->userdata('lang')) {
                                    $type = $this->session->userdata('lang');
                                    if ($type == 'english') {
                                        ?>
                                        <img width="24" src="<?php echo base_url(); ?>/images/vi24.png">
                                    <?php
                                    } else if ($type == 'vietnam') {
                                        ?>
                                        <img width="24" src="<?php echo base_url(); ?>/images/en24.png">
                                    <?php
                                    }
                                } else {
                                    ?>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="<?php echo $admin_url; ?>orders"><?php echo lang('common_orders') ?></a>
                                </li>
                        ...
                        if ($this->auth->check_access('Admin')) : ?>
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle"
                                   data-toggle="dropdown"><?php echo lang('common_catalog') ?>
                                    / <?php echo lang('common_products') ?> <b class="caret"></b></a>
                                <ul class="dropdown-menu">
                                    <li>
                                    ...
                                    <!--                            <li><a href="-->
                                    <?php //echo $admin_url;?><!--digital_products">-->
                                    <?php //echo lang('common_digital_products') ?><!--</a></li>-->
                                </ul>
                            </li>

                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle"
                                   data-toggle="dropdown"><?php echo lang('common_content') ?> <b class="caret"></b></a>
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="<?php echo $admin_url; ?>banners"><?php echo lang('common_banners') ?></a>
                                    </li>
                                    <li><a href="<?php echo $admin_url; ?>pages"><?php echo lang('common_pages') ?></a>
                                    </li>
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="<?php echo $admin_url; ?>settings"><?php echo lang('common_gocart_configuration') ?></a>
                                    </li>
                                    <li>
                                        <a href="<?php echo $admin_url; ?>shipping"><?php echo lang('common_shipping_modules') ?></a>
                                    </li>
                                    <li>
                                        <a href="<?php echo $admin_url; ?>payment"><?php echo lang('common_payment_modules') ?></a>
                                    </li>
                                    <li>
                                        <a href="<?php echo $admin_url; ?>settings/canned_messages"><?php echo lang('common_canned_messages') ?></a>
                                    </li>
                                    <li>
                    ...
                    <ul class="nav pull-right">
                        <li>
                            <a href="<?php echo site_url(); ?>"
                               target="_blank"><?php echo lang('common_front_end') ?></a>
                        </li>
                    </ul>
                    <ul class="nav pull-right">
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle"
                               data-toggle="dropdown"><?php echo lang('common_actions'); ?> <b class="caret"></b></a>
                            <ul class="dropdown-menu">
                                <li>
                                    <a href="<?php echo site_url($this->config->item('admin_folder') . '/dashboard'); ?>"><?php echo lang('common_dashboard') ?></a>
                                </li>
                                <li><a href="<?php echo site_url(); ?>"><?php echo lang('common_front_end') ?></a></li>
                                <li>
                                    <a href="<?php echo site_url($this->config->item('admin_folder') . '/login/logout'); ?>"><?php echo lang('common_log_out') ?></a>
                                </li>
                            </ul>
                        </li>
                    </ul>
