...
<fieldset>
    <legend><?php echo lang('info_settings');?></legend>

    <div class="row">
        <div class="span3">
            <label><?php echo lang('info_hotline');?></label>
            <?php echo form_input(array('name'=>'info_hotline', 'class'=>'span3','value'=>set_value('info_hotline',$info_hotline)));?>
        </div>
        <div class="span3">
            <label><?php echo lang('info_phone');?></label>
            <?php echo form_input(array('name'=>'info_phone', 'class'=>'span3','value'=> set_value('info_phone',$info_phone)));?>
        </div>
        <div class="span3">
            <label><?php echo lang('info_fax');?></label>
            <?php echo form_input(array('name'=>'info_fax', 'class'=>'span3','value'=> set_value('info_fax',$info_fax)));?>
        </div>
        <div class="span3">
            <label><?php echo lang('info_email');?></label>
            <?php echo form_input(array('name'=>'info_email', 'class'=>'span3','value'=> set_value('info_email',$info_email)));?>
        </div>
    </div>
    <div class="row">
        <div class="span4">
            <label><?php echo lang('info_yahoo');?></label>
            <?php echo form_input(array('name'=>'info_yahoo', 'class'=>'span4','value'=> set_value('info_yahoo',$info_yahoo)));?>
        </div>
        <div class="span4">
            <label><?php echo lang('info_skype');?></label>
            <?php echo form_input(array('name'=>'info_skype', 'class'=>'span4','value'=> set_value('info_skype',$info_skype)));?>
        </div>
        <div class="span4">
            <label><?php echo lang('info_youtube');?></label>
            <?php echo form_input(array('name'=>'info_youtube', 'class'=>'span4','value'=> set_value('info_youtube',$info_youtube)));?>
        </div>
    </div>
    <div class="row">
        <div class="span4">
            <label><?php echo lang('info_facebook');?></label>
            <?php echo form_input(array('name'=>'info_facebook', 'class'=>'span4','value'=> set_value('info_facebook',$info_facebook)));?>
        </div>
        <div class="span4">
            <label><?php echo lang('info_google');?></label>
            <?php echo form_input(array('name'=>'info_google', 'class'=>'span4','value'=> set_value('info_google',$info_google)));?>
        </div>
        <div class="span4">
            <label><?php echo lang('info_twitter');?></label>
            <?php echo form_input(array('name'=>'info_twitter', 'class'=>'span4','value'=> set_value('info_twitter',$info_twitter)));?>
        </div>
    </div>
